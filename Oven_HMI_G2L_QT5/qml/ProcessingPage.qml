...
// Qt5 port: QtMultimedia import removed; background video disabled.
...
Item {
    ...
    SequentialAnimation {
        ...
        ScriptAction { script: { processingRoot.processingComplete = true; processingRoot.finished() } }
    }
    ...
    // Replaced the looping .mov with a solid dark background.
    ...
    Rectangle {
            ...
            View3D {
                ...
                // Qt5 port: OrbitCameraController (Qt6-only, absent from this
                // Quick3D 1.15 backport's Helpers) removed. The model auto-rotates
                // below instead of being mouse-orbited.
                ...
                Node {
                    ...
                    // Auto-rotate the model (replaces the removed OrbitCameraController).
